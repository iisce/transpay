  ...
  return (
    <>
      ...
      <p className="text-[11x]">
        We sent a code to <b className="font-bold">iscedigital@gmail.com</b>
      </p>
      <div className="ml-5 mt-1">
        <AuthVerification detail="Enter code" type="text" />
        ...
        <p className="mt-3 text-center text-[12px]">
          Didn’t Receive Code?
          <Link className="text-primary-900 font-bold" href="">
            Resend Code
          </Link>
        </p>
        <div className="flex mt-3 justify-center">
          <Link className="mt-[5px]" href="/auth">
            {backArrowIcon}
          </Link>
