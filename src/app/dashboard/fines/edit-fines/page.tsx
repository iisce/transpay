      ...
      <div className=" p-10 w-full h-full overflow-y-scroll">
        ...
        <div className="grid py-2">
          ...
          <input
            ...
            type="text"
            placeholder="This is when a driver makes a late payment. A late payment is when a driver is short of payment by a day or more."
          />
        </div>
        <div className="grid">
