  ...
  return (
    <div className="w-full p-10">
      ...
      <div className=" flex justify-center gap-4">
        ...
        >
          <Link href={"dashboard/drivers/waiver/history"}>Back</Link>
        </Button>
          ...
          <AlertDialogContent className="bg-secondary">
            <div className="w-60 mx-auto flex-col">
              <div className="flex flex-col items-center gap-5 mb-5">
                ...
                <div className="">
                  <h1 className=" font-bold text-xl">PROCESSING WAIVER</h1>
                  <div className=" text-base">
                  <p>Dear customer,</p>
                  <p>
                    <span className=" pl-9">
                      Your request of waiver is bing processd{" "}
                    </span>{" "}
                    you'll be alert by via number for confirmation
                  </p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-3">
                <AlertDialogAction asChild className="rounded-xl">
                  <Link href={`/dashboard/drivers/driversid`}>VIEW DRIVER ACCOUNT</Link>
                </AlertDialogAction>
                <AlertDialogCancel asChild className="rounded-xl">
                  <Link href={`/dashboard/drivers`}>DASHBOARD</Link>
                </AlertDialogCancel>
              </div>
            </div>
          </AlertDialogContent>
