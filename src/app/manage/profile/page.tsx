...
import { ADDRESS_INFORMATION, PERSONAL_INFORMATION } from "@/lib/consts";
...
export default function ProfilePage() {
  return (
    <div className="flex flex-col gap-6 px-5 w-screen overflow-y-scroll pb-20">
      ...
      <div className="bg-primary-50 lg:w-[926px] lg:text-left text-center items-center  rounded-[20px] py-[30px] lg:pl-5 flex gap-7 flex-col lg:flex-row">
        <Image src="/avater2.png" alt="avater" width="90" height="90" />
        <div className="flex flex-col gap-2">
          <h2 className="text-h5Bold">Agent ISCE</h2>
          <p className="text-title1Bold text-gray-500">Isaac Emperor</p>
      ...
      <InformationCard header="Address" link="" info={ADDRESS_INFORMATION} />
    </div>
  );
}
