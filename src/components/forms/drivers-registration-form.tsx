...
const driverFormSchema = z.object({
 ...
 confirmPassword:z
  ...
  meansOfIdentification: z
    ...
    .refine(
      (value) =>
        ["Voters Card", "NIN", "Passport", "Drivers Licenses"].includes(value),
      {
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-title1Bold pl-4">Name</FormLabel>
          ...
          <FormField
            ...
            render={({ field }) => (
                <FormItem>
                <FormLabel className="text-title1Bold pl-4">Means Of Identification</FormLabel>
               ...
               defaultValue={field.value}>
                ...
                <SelectContent>
                    ...
                    <SelectItem value="driversLicence">Drivers Licence</SelectItem>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-title1Bold pl-4">Email</FormLabel>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-title1Bold pl-4">Address</FormLabel>
          ...
          <FormField
           ...
           control={form.control}
            render={({ field }) => (
                <FormItem>
                    <FormLabel className="text-title1Bold pl-4" >Confirm Password</FormLabel >
              <FormControl>
                <Input
                className="relative text-body flex  items-center h-14 rounded-2xl"
                  {...field}
